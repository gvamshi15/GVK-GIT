...
<xsl:param name="body.font.family">Cyrillic</xsl:param>
	...
	<xsl:template name="staticPacketData">
		<fo:block font-size="25pt" font-family="Cyrillic" text-align="left">
		...
		<fo:block font-size="22pt" font-family="Cyrillic" text-align="left" padding-top="0.8cm">
			<xsl:value-of select="../supplier" />
		</fo:block>
							
		<fo:block font-size="22pt" font-family="Cyrillic" text-align="left">
		...
		<fo:block font-size="20pt" font-family="Cyrillic" text-align="left" padding-top="0.8cm">
			...
			<fo:page-sequence master-reference="simple">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<xsl:for-each select="packet-pos-list">
						...
						<fo:block padding-top="0.5cm" padding-bottom="1cm" text-align="center">
